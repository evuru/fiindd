                                ...
                                <div class="p-4 p-sm-7">
                                    ...
                                    <form class="mt-4 text-start" method="post">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="email" class="form-control <?php echo $model->hasError('login')?'is-invalid':'';?>" name="email" required>
                                        </div>
                                        <!-- Password -->
                                        <div class="mb-3 position-relative">
                                            <label class="form-label">Enter password</label>
                                            <input class="form-control fakepassword <?php echo $model->hasError('login')?'is-invalid':'';?>" type="password" id="psw-input" name="password" required>
                                            <span class="position-absolute top-50 end-0 translate-middle-y p-0 mt-3">
											<i class="fakepasswordicon fas fa-eye-slash cursor-pointer p-2"></i>
										</span>
                                        </div>
                                        <div class="mb-3 position-relative"><!--dummy was added just to display errors-->
                                            <input class="<?php echo $model->hasError('login')?'is-invalid':'';?>" hidden>
