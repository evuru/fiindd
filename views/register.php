                                ...
                                <div class="p-4 p-sm-6">
                                    ...
                                    <form class="mt-4 text-start" method="post">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control <?php echo $model->hasError('firstname')?'is-invalid':'';?>" name="firstname">
                                            <div class="invalid-feedback"><?php foreach ($model->errors['firstname'] as $firstnameError){echo $firstnameError;}?></div>
                                        </div>
                                        <!-- Last name -->
                                        <div class="mb-3">
                                            <label class="form-label">Last Name</label>
                                            <input type="text" class="form-control <?php echo $model->hasError('lastname')?'is-invalid':'';?>" name="lastname">
                                            <div class="invalid-feedback"><?php foreach ($model->errors['lastname'] as $lastnameError){echo $lastnameError;}?></div>
                                        </div>
                                        <!-- Email -->
                                        <div class="mb-3">
                                            <label class="form-label">Email</label>
                                            <input type="email" class="form-control <?php echo $model->hasError('email')?'is-invalid':'';?>" name="email">
                                        ...
                                        <div class="mb-3 position-relative">
                                            ...
                                            <input class="form-control fakepassword <?php echo $model->hasError('password')?'is-invalid':'';?>" type="password" id="psw-input" name="password">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="password" class="form-control <?php echo $model->hasError('cpassword')?'is-invalid':'';?>" name="cpassword">
