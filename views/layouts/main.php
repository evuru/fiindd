<?php use evuru\chintuaphpmvc\Application;?>

<!DOCTYPE html>
<html lang="en">
<head>
    <title>Fiindd - Luxury</title>

    <!-- Meta Tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="author" content="fiindd.com">
    <meta name="description" content="fiindd - Luxury">
            ...
            <ul class="nav flex-row align-items-center list-unstyled ms-xl-auto">
                ...
                <li class="nav-item align-items-center d-none d-sm-flex position-relative me-sm-3">
                    ...
                    <div class="ms-2 d-none d-md-block">
                        ...
                        <p class="small mb-0 text-body">Get exciting welcome offers
                            <?php echo Application::$app->user?Application::$app->user->getDisplayName():'';?>
                        </p>
                    </div>
                </li>
                ...
                <li class="nav-item dropdown">
                    <a class="icon-md btn btn-light mb-0 p-0" href="#" id="languageDropdown" role="button" data-bs-auto-close="outside" data-bs-display="static" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <li class="nav-item ms-3">
                    <a href="/login" class="btn btn-sm btn-primary mb-0"><i class="fa-solid fa-right-to-bracket me-2"></i>Sign in/up</a>
                </li>
                <!-- Login button END -->
                <?php else: ?>
                <li class="nav-item ms-3">
                    <a href="/logout" class="btn btn-sm btn-primary mb-0"><i class="fa-solid fa-right-to-bracket me-2"></i>Logout</a>
                </li>
                <?php endif; ?>
            </ul>
            <!-- Buttons START -->
